...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=134495242ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="287">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=consumption_management&table=consumption">`consumption_management`.`consumption`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=electrogridcomp&table=consumption">`electrogridcomp`.`consumption`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=electrogridcomp&table=billing">`electrogridcomp`.`billing`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=consumptionmanagement&table=consumption">`consumptionmanagement`.`consumption`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="47273d687a304e617d7b596a4964364d">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="287"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
...
<div id="topmenucontainer" class="menucontainer">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="consumption_management" targettable="consumption">
            ...
            Database
                            : <span>consumption_management</span>
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `consumption`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="consumption_management" targettable="consumption">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `consumption` DROP `RangeOfUnit`;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="consumption_management" targettable="consumption">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `consumption` ADD PRIMARY KEY(`Consum_ID`);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="consumption_management" targettable="consumption">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `consumption` DROP `Consum_ID`;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="consumption_management" targettable="consumption">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `consumption`</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="consumption_management" targettable="">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `consumption` (`Consum_ID`, `RangeOfUnit`, `Price`, `Date`, `Comments`) VALUES (&#039;01&#039;, &#039;01-25&#039;, &#039;50.00&#039;, &#039;02-03-2022&#039;, &#039;Test1&#039;), (&#039;02&#039;, &#039;26-75&#039;, &#039;100&#039;, &#039;09-08-2022&#039;, &#039;Test2&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="consumption_management" targettable="consumption">
                            <div class="action_content">
